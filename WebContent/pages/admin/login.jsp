...
<body bgcolor="#E7ECEF">
    <center>
    	<form id="loginForm" action="cityinfo/user!login" method="post">
                    ...
                    <td background="images/logon_middle.gif" align="center" valign="top">
                         <table border="0" width="90%" cellspacing="0" cellpadding="0">
                             ...
                             <tr height="30">
                                 ...
                                 <td style="text-indent:5"><input type="text" name="user.userName" id="userName" value="${user.userName }" size="30"/></td>
                             </tr>                
                             <tr height="30">
                                 <td align="right">密&nbsp;&nbsp;码：&nbsp;&nbsp;</td>
                                 <td style="text-indent:5"><input type="password" name="user.password" id="password" value="${user.password }" size="30"/></td>
                             </tr>
                             <tr height="60">
                                 <td></td>
                                 <td>
